    ...
    <div>
      ...
      <List style={{padding: 0}}>
        ...
        <ListItem button key={0} onClick={() => {
          ...
          <Icon type="setting" className={classes.menuIcon}/>
          <ListItemText disableTypography primary="Settings" classes={{root: classes.menuText}}/>
          {dropDown.settings ? <ExpandLess/> : <ExpandMore/>}
        </ListItem>
        <Collapse in={dropDown.settings} unmountOnExit>
          <Link to="/admin/settings/index">
            <ListItem button className={classes.secondMenuItem}>
              <Icon type="home" className={classes.menuIcon}/>
              <ListItemText disableTypography
                            primary="Index" classes={{root: classes.secondMenuText}}/>
            </ListItem>
          </Link>
          <Link to="/admin/settings/blogs">
            <ListItem button className={classes.secondMenuItem}>
              <Icon type="file-text" className={classes.menuIcon}/>
              <ListItemText disableTypography
                            primary="Blogs" classes={{root: classes.secondMenuText}}/>
            </ListItem>
          </Link>
        </Collapse>
        ...
        <Collapse in={dropDown.notes} unmountOnExit>
          <Link to="/admin/blogs">
            <ListItem button className={classes.secondMenuItem}>
        ...
        <Collapse in={dropDown.ui} unmountOnExit>
        ...
        <Collapse in={dropDown.upload} unmountOnExit>
