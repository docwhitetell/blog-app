  ...
  return (
    <Card style={{ width: '100%', marginTop: 20, minHeight: 400 }}>
      <AppBar position="static" style={{ position: 'relative', height: '50px' }}>
        <span style={{ position: 'absolute', left: 20, top: 0, height: 50, lineHeight: '50px', fontSize: 16 }}>Online Hot Search Table</span>
        <Menu
          mode="horizontal"
          style={{
        ...
        >
          <SubMenu
            ...
            title={<Icon type="ellipsis" style={{ fontSize: 18, marginTop: 14, color: '#ffffff' }} />}
          >
